...
const App = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/images" element={<PrivateRoute isLogged={isLogged}> <Navbar/> <Images darkMode={darkMode} setDarkMode={setDarkMode} /> <Footer/> </PrivateRoute>} />
      <Route path="/icons" element={<PrivateRoute isLogged={isLogged}> <Navbar/> <Icons darkMode={darkMode} setDarkMode={setDarkMode} /> <Footer/> </PrivateRoute>} />
      <Route path="/stages" element={<PrivateRoute isLogged={isLogged}> <Navbar /> <Stages darkMode={darkMode} setDarkMode={setDarkMode} /> <Footer /> </PrivateRoute>} />
      <Route path="/contents" element={<PrivateRoute isLogged={isLogged}> <Navbar/> <Contents darkMode={darkMode} setDarkMode={setDarkMode} /> <Footer/> </PrivateRoute>} />
